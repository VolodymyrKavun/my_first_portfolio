    ...
    >
      ...
      <div className="contact__form-container">
        ...
        >
          ...
          />
          <button className="contact__form--button" aria-label="Send message">
            Submit
          </button>
...
//         <motion.ul variants={variants} className="list">
//           {contactData.map((item) => (
//             <motion.li variants={variants} className="item" key={item.id}>
//               <h2>{item.title}</h2>
//               <p>{item.text}</p>
//             </motion.li>
//           ))}
